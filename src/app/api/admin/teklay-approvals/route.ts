// GET /api/admin/teklay-approvals
// System Admin views Teklay registration approvals
...
export async function GET(req: NextRequest) {
  try {
    ...
    if (!adminRole) {
      return errorResponse("Only System Admin can access this", 403);
    }
    ...
    // Get teklay registrations with profile info
    ...
    console.error("Get Teklay approvals error:", error);
